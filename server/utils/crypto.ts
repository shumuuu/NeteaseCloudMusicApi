...
export const weapi = (object: Record<string, any>): { params: string; encSecKey: string } => {
...
export const linuxapi = (object: Record<string, any>): { eparams: string } => {
  const text = JSON.stringify(object)
  return {
...
export const eapi = (url: string, object: Record<string, any> | string): { params: string } => {
